...
namespace FrostAndGunfireItems
{
	...
	public class Fury : PassiveItem
	{
	
		// Token: 0x060000C2 RID: 194 RVA: 0x000084CC File Offset: 0x000066CC
		public static void Init()
		{
			string name = "Fury";
			string resourcePath = "FrostAndGunfireItems/Resources/rage";
			GameObject gameObject = new GameObject(name);
			Fury rage = gameObject.AddComponent<Fury>();
			...
			ItemBuilder.SetupItem(rage, shortDesc, longDesc, "kp");
			rage.quality = PickupObject.ItemQuality.EXCLUDED;
		}

		// Token: 0x060000C3 RID: 195 RVA: 0x00008524 File Offset: 0x00006724
		...
		public override DebrisObject Drop(PlayerController player)
		{
			...
			Fury component = debrisObject.GetComponent<Fury>();
