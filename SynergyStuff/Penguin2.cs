...
namespace FrostAndGunfireItems
{
	...
	public class Penguin2 : CompanionItem
	{
		// Token: 0x0600005F RID: 95 RVA: 0x000052CC File Offset: 0x000034CC
		public static void Init()
		{
			string name = "hfhvbsbsbb hsv";
			string resourcePath = "FrostAndGunfireItems/Resources/crown";
			GameObject gameObject = new GameObject();
			Penguin2 penguin2 = gameObject.AddComponent<Penguin2>();
			...
			ItemBuilder.SetupItem(penguin2, shortDesc, longDesc, "kp");
			penguin2.quality = PickupObject.ItemQuality.EXCLUDED;
			penguin2.CompanionGuid = Penguin2.guid;
			penguin2.Synergies = new CompanionTransformSynergy[0];
			Penguin2.BuildPrefab();
			ItemBuilder.AddPassiveStatModifier(penguin2, PlayerStats.StatType.Coolness, 1f, StatModifier.ModifyMethod.ADDITIVE);
		}
		...
		public static void BuildPrefab()
		{
			...
			bool flag = Penguin2.PenguinPrefab2 != null || CompanionBuilder.companionDictionary.ContainsKey(Penguin2.guid);
			bool flag2 = flag;
			if (!flag2)
			{
				Penguin2.PenguinPrefab2 = CompanionBuilder.BuildPrefab("Penguin2", Penguin2.guid, Penguin2.spritePaths[0], new IntVector2(3, 2), new IntVector2(8, 9));
				Penguin2.PenguinBehavior2 penguinBehavior2 = Penguin2.PenguinPrefab2.AddComponent<Penguin2.PenguinBehavior2>();
				AIAnimator aiAnimator = penguinBehavior2.aiAnimator;
				...
				bool flag3 = Penguin2.penguinCollection2 == null;
				if (flag3)
				{
					Penguin2.penguinCollection2 = SpriteBuilder.ConstructCollection(Penguin2.PenguinPrefab2, "Penguin_Collection2");
					UnityEngine.Object.DontDestroyOnLoad(Penguin2.penguinCollection2);
					for (int i = 0; i < Penguin2.spritePaths.Length; i++)
					{
						SpriteBuilder.AddSpriteToCollection(Penguin2.spritePaths[i], Penguin2.penguinCollection2);
					}
					SpriteBuilder.AddAnimation(penguinBehavior2.spriteAnimator, Penguin2.penguinCollection2, new List<int>
					{
						0,
						1,
						2,
				...
				penguinBehavior2.aiActor.MovementSpeed = 7f;
				penguinBehavior2.specRigidbody.Reinitialize();
				penguinBehavior2.specRigidbody.CollideWithTileMap = false;
				penguinBehavior2.aiActor.CanTargetEnemies = true;
				BehaviorSpeculator behaviorSpeculator = penguinBehavior2.behaviorSpeculator;
					behaviorSpeculator.AttackBehaviors.Add(new Penguin2.PenguinAttackBehavior2());
				behaviorSpeculator.MovementBehaviors.Add(new Penguin2.ApproachEnemiesBehavior());
				...
				UnityEngine.Object.DontDestroyOnLoad(Penguin2.PenguinPrefab2);
				FakePrefab.MarkAsFakePrefab(Penguin2.PenguinPrefab2);
				Penguin2.PenguinPrefab2.SetActive(false);
			}
		}

		// Token: 0x04000016 RID: 22
		public static GameObject PenguinPrefab2;

		// Token: 0x04000017 RID: 23
		public static readonly string guid = "orgalorg";

		// Token: 0x04000018 RID: 24
		private static string[] spritePaths = new string[]
		{
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_left_001",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_left_002",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_left_003",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_left_004",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_right_001",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_right_002",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_right_003",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_idle_right_004",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_left_001",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_left_002",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_left_003",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_left_004",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_left_005",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_left_006",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_left_007",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_right_001",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_right_002",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_right_003",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_right_004",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_right_005",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_right_006",
			"FrostAndGunfireItems/Resources/penguin2/penguin2_run_right_007"
		};

		// Token: 0x04000019 RID: 25
		private static tk2dSpriteCollectionData penguinCollection2;

		// Token: 0x02000031 RID: 49
		public class PenguinBehavior2 : CompanionController
		{
		...
		public class PenguinAttackBehavior2 : AttackBehaviorBase
		{
			...
			public override void Init(GameObject gameObject, AIActor aiActor, AIShooter aiShooter)
			{
				...
				this.Owner = this.m_aiActor.GetComponent<Penguin2.PenguinBehavior2>().Owner;
			}
